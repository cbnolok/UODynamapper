...
fn main() {
    ...
    App::new()
        ...
        .add_plugins(MaterialPlugin::<ExtendedMaterial<StandardMaterial, TerrainMaterialExtension>>::default())   // ← registers Assets<TerrainMaterial>, TODO: do this in a separate startup system
