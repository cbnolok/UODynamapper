...
pub fn run() -> eyre::Result<()> {
    ...
    match Cli::parse().command {
        Commands::PackArt {
            ...
            let compression = if bc7 { UddCompressionFlag::None } else { UddCompressionFlag::ZstdNoDict };
        ...
        Commands::PackEcTextures {
            ...
            let art_summary = convert_ec_art_uop_to_ec_art_uddp_from_loaded_sources(
                ...
                &EcArtAtlasOptions {
                    ...
                    compression: UddCompressionFlag::ZstdNoDict, // EC Art always uses Zstd here
            ...
            let land_summary = convert_ec_land_uop_to_ec_land_uddp_from_loaded_sources(
                ...
                &EcLandAtlasOptions {
                    ...
                    gutter: land_gutter,
                    compression: if land_bc7 { UddCompressionFlag::None } else { UddCompressionFlag::ZstdNoDict },
                    upscale_64: uddconv::upscale::UpscaleConfig {
                        target_size: upscale_64_size,
                        filter: upscale_64_algo.into(),
                    },
                    upscale_128: uddconv::upscale::UpscaleConfig {
                        target_size: upscale_128_size,
                        filter: upscale_128_algo.into(),
                    },
                    upscale_256: uddconv::upscale::UpscaleConfig {
